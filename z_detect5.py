...
class AimYolo:
    ...
    def __init__(self, opt):
        ...
        self.bounding_box = {'left': 0, 'top': 0, 'width': 2560, 'height': 1600}
...
def parseArgs():
    ...
    parser.add_argument('--cs2', nargs='+', type=str, default='weights/best_cs2_model.pt', help='mode2.pt path(s)')
